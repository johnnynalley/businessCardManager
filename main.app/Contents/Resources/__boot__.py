...
_recipes_pil_prescript(['MpegImagePlugin', 'PsdImagePlugin', 'IptcImagePlugin', 'FtexImagePlugin', 'IcnsImagePlugin', 'MicImagePlugin', 'Jpeg2KImagePlugin', 'PcxImagePlugin', 'FitsImagePlugin', 'FpxImagePlugin', 'XVThumbImagePlugin', 'ImtImagePlugin', 'ImImagePlugin', 'WebPImagePlugin', 'EpsImagePlugin', 'SpiderImagePlugin', 'GribStubImagePlugin', 'BmpImagePlugin', 'PcdImagePlugin', 'PpmImagePlugin', 'PdfImagePlugin', 'SgiImagePlugin', 'PixarImagePlugin', 'SunImagePlugin', 'PngImagePlugin', 'QoiImagePlugin', 'BufrStubImagePlugin', 'TiffImagePlugin', 'MspImagePlugin', 'Hdf5StubImagePlugin', 'IcoImagePlugin', 'XbmImagePlugin', 'WmfImagePlugin', 'DcxImagePlugin', 'McIdasImagePlugin', 'DdsImagePlugin', 'MpoImagePlugin', 'JpegImagePlugin', 'GifImagePlugin', 'PalmImagePlugin', 'FliImagePlugin', 'TgaImagePlugin', 'XpmImagePlugin', 'GbrImagePlugin', 'BlpImagePlugin', 'CurImagePlugin'])
